...
-- Standalone (no WoW dependencies). Used to bridge LibSerialize output → JS.
-- Integer-keyed sequences (Lua arrays) encode as JSON arrays;
-- string/mixed-keyed tables encode as JSON objects.
