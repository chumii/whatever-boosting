...
local function makeRow(parent, idx)
    ...
    row.mainLabel    = lbl(COLS.main,    nil, 0.7, 0.7, 0.7)
...
function WB.RebuildRows()
    ...
    for idx, entry in ipairs(chars) do
        ...
        row.mainLabel:SetText(data.main_role or "—")
...
local function buildMainFrame()
    ...
    mainFrame:Hide()
    mainFrame.TitleText:SetText("Whatever Boosting")
